...
from .leggy_jump import leggy_jump_env_cfg, leggy_jump_rl_cfg
...
register_mjlab_task(
    task_id="Mjlab-Jump-Flat-Leggy",
    env_cfg=leggy_jump_env_cfg(play=False),
    play_env_cfg=leggy_jump_env_cfg(play=True),
    rl_cfg=leggy_jump_rl_cfg(),
)
